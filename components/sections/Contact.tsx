...
export default function Contact() {
  return (
    <section id="contact" className="bg-[#f8ffe4] py-16 md:py-32 flex justify-center">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-20 items-start md:w-[1446px]">
          ...
          <div className="space-y-6 md:space-y-8 md:max-w-[538px]">
            ...
            <div>
              ...
              <p className="text-[#242424] text-sm md:text-[16px]">
                Waveafricansocial@gmail.com
              </p>
            </div>

            <div>
              <h3 className="text-[#1A5A45] text-lg md:text-xl font-bold mb-2">Socials</h3>
          ...
          {/* Right — form */}
          <form className="space-y-4 w-full md:max-w-[578px]" onSubmit={(e) => e.preventDefault()}>
            <div>
              <label className="text-[#242424] text-sm md:text-[18px] mb-1 block">Name</label>
              <input
                type="text"
                name="name"
                aria-label="Name"
            ...
            <div>
              <label className="text-[#242424] text-sm md:text-[18px] mb-1 block">Email</label>
              <input
                type="email"
                name="email"
                className="w-full bg-[#E5E5E5] rounded-xl px-4 md:px-5 h-14 md:h-[65px] text-gray-800 text-sm md:text-[18px] outline-none focus:ring-2 focus:ring-[#1A5A45]"
            ...
            <div>
              <label className="text-[#242424] text-sm md:text-[18px] mb-1 block">Message</label>
              <textarea
                name="message"
                rows={6}
