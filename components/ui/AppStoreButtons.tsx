...
export default function AppStoreButtons({ className }: AppStoreButtonsProps) {
  return (
    <div className={`flex items-center gap-3 ${className ?? ""}`}>
      <a
        href="#"
        className="flex items-center gap-2 bg-black border border-gray-700 rounded-lg px-3 py-2 hover:border-gray-500 transition-colors"
      >
        <img src="/icons/google-play.svg" alt="" className="w-5 h-5" />
        <div>
