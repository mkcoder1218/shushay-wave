    ...
    >
      <div
        className={clsx(
          ...
          "md:left-6 md:right-6 md:block md:h-[55%] lg:left-10 lg:right-10",
      ...
      <div
        className={clsx(
          ...
          "md:hidden md:h-[55%] md:left-6 md:right-6 lg:left-10 lg:right-10",
          "xl:left-12 xl:right-12 2xl:left-20 2xl:right-20",
        )}
      />
      ...
      <Container className="relative py-12 md:py-14 lg:py-16 xl:py-16 2xl:py-20">
        ...
        <div
          className={clsx(
            "grid grid-cols-1 items-end gap-6 px-2 text-center md:grid-cols-2",
