  ...
  return (
    ...
    >
      <div className="mb-12 px-4 text-center">
        <p className="mb-2 text-[18px] font-medium text-[#1A5A45]">
          Testimonials
        </p>
        <h2 className="text-3xl font-bold text-[#1A5A45] md:text-3xl lg:text-4xl xl:text-[56px]">
      ...
      <div className="relative mx-auto flex w-full items-center justify-center gap-3 overflow-hidden px-4 md:w-full lg:w-[90%] xl:w-full xl:max-w-[1200px] xl:gap-4 2xl:w-400 2xl:max-w-none 2xl:gap-4">
        <div className="hidden min-h-[280px] h-[380px] flex-shrink-0 overflow-hidden rounded-3xl bg-[#1a1a1a] p-6 lg:block lg:w-72 xl:w-64 2xl:h-[449px] 2xl:w-100">
          <TestimonialCard
        ...
        <div className="relative w-full flex-shrink-0 lg:w-[min(100%,640px)] xl:w-[min(100%,680px)] 2xl:w-200">
          <button
            onClick={prev}
            className="absolute left-4 top-1/2 z-10 flex h-10 w-10 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-white text-black shadow-lg transition-colors hover:bg-gray-100 lg:left-16"
          ...
          <div className="flex min-h-[280px] h-auto flex-col justify-between rounded-3xl bg-[#85E0404D] p-8 shadow-xl md:p-8 lg:h-[380px] lg:p-9 xl:p-9 2xl:h-[449px] 2xl:p-10">
            <TestimonialCard
          ...
          <button
            onClick={next}
            className="absolute right-4 top-1/2 z-10 flex h-10 w-10 translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-white text-black shadow-lg transition-colors hover:bg-gray-100 lg:right-16"
        ...
        <div className="hidden min-h-[280px] h-[380px] flex-shrink-0 overflow-hidden rounded-3xl bg-gray-100 p-6 lg:block lg:w-72 xl:w-64 2xl:h-[449px] 2xl:w-100">
          <TestimonialCard
            testimonial={TESTIMONIALS[getIndex(1)]}
            className="h-full"
            quoteClassName="text-center text-sm leading-relaxed text-gray-700 lg:text-lg xl:text-[24px]"
