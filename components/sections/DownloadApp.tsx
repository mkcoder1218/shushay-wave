  ...
  return (
    <section className="bg-[#f8ffe4] py-12 md:py-14 lg:py-16 relative overflow-hidden">
      ...
      <Container className="relative px-4 md:mx-4 lg:mx-8 xl:mx-12 2xl:ml-100 2xl:mr-100">
        <div className="relative rounded-3xl overflow-hidden min-h-[300px] md:min-h-[300px] lg:min-h-[350px] xl:min-h-[360px] 2xl:min-h-[390px]">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center">
            <div className="flex-1 p-6 md:p-8 lg:p-10 xl:p-10 2xl:p-12 flex flex-col gap-4 md:max-w-[58%] lg:max-w-[55%] xl:max-w-[52%] 2xl:max-w-none">
              <h2 className="text-white text-xl md:text-2xl lg:text-3xl xl:text-3xl 2xl:text-[36px] font-bold leading-snug">
                Download the Wave Equb App Now!
              </h2>
              <p className="text-white text-sm md:text-base lg:text-base xl:text-base 2xl:text-[18px] lg:max-w-[480px] 2xl:max-w-[560px]">
