  ...
  return (
    ...
    >
      {card.center ? (
        <div
          className={clsx(
            "flex min-h-100 flex-col justify-end lg:items-end overflow-hidden pb-8",
            "md:min-h-[400px] md:pb-10 lg:min-h-[500px] lg:pb-12 xl:min-h-[480px]",
            "xl:pb-10 2xl:min-h-[628px] 2xl:flex-row 2xl:pb-16",
          )}
        >
          <div
            className={clsx(
